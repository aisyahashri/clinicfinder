...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        centerlocation = new LatLng(6.446486284022304, 100.27509889139648);
        ...
        markerOptions.add(new MarkerOptions().title("Poliklinik Dr.Azhar dan Rakan-rakan Pauh")
                ...
                .snippet("9AM - 10PM"));
        markerOptions.add(new MarkerOptions().title("Poliklinik Dr.Azhar dan Rakan-rakan Jejawi ")
                .position(new LatLng(6.444927262915474, 100.23600265757386))
                .snippet("8AM - 9PM"));
        ...
        markerOptions.add(new MarkerOptions().title("KLINIK REMEDIC PAUH ")
                .position(new LatLng(6.437276139032896, 100.30369620760084))
                .snippet("OPEN 24h"));
    }
